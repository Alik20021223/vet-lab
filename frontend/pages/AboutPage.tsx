...
import aboutUsMainImage from '../assets/about-us-main.png';
import { 
  CheckCircle2, 
  Target, 
  Users, 
                ...
                <div className="grid grid-cols-2 gap-4">
                  {directions.map((direction, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="flex items-center gap-3 p-4 max-md:p-2 bg-white rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition-shadow"
                      >
                        <div
                        ...
                        <span className="font-medium text-gray-800 max-md:text-sm max-md:text-xs">{direction.title}</span>
                      </div>
                    );
                  })}
                </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src={aboutImage}
                  alt="Команда VET-LAB"
                  className="w-full h-[500px] object-cover max-md:object-[80%]"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-6">
              {advantages.map((advantage, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex items-start gap-4 bg-white rounded-xl p-6 max-md:p-4 border border-gray-100 shadow-md hover:shadow-lg transition-shadow"
                  >
                    <div
