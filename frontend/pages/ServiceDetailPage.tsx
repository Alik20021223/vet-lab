        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="relative">
              <ImageWithFallback
                src={serviceData.image || 'https://images.unsplash.com/photo-1631557676757-fcc7b1160be8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpY2FsJTIwbGFib3JhdG9yeSUyMHJlc2VhcmNofGVufDF8fHx8MTc2NDU3NzMwNXww&ixlib=rb-4.1.0&q=80&w=1080'}
