          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href={`tel:${BRAND.contact.phone}`} className="text-white/90 hover:text-white transition-colors text-sm">
                  {BRAND.contact.phone}
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-5 h-5 shrink-0" />
                <a href={`mailto:${BRAND.contact.email}`} className="text-white/90 hover:text-white transition-colors text-sm">
                  {BRAND.contact.email}
                </a>
              </li>
            </ul>
